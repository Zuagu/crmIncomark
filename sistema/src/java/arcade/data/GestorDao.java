...
//                        + "<td>" + c.getPuesto() + "</td>"
   ...
   public static String update_gestor(int id_gestor) {
    ...
    //==========================================================================
    public static String insert_enviar_block(int id_gestor, String nota) {
        try {
            StartConn s = new StartConn();
            String resultado = "Nota Insertada";
            String sql = "UPDATE arcade_usuarios set notas = '"+ nota +"' where id = '"+ id_gestor +"';";
            System.out.println(sql);
            s.st.executeUpdate(sql);
    ...
    //==========================================================================
    public static String select_texto_block(int id_gestor) {
        try {
            StartConn s = new StartConn();
            String resultado = "";
            String sql = "SELECT notas from arcade_usuarios where id = '"+ id_gestor +"';";
            System.out.println(sql);
            s.rs = s.st.executeQuery(sql);
            while (s.rs.next()) {
                resultado = (s.rs.getString("notas"));
            }
            s.rs.close();
            s.st.close();
            s.conn.close();

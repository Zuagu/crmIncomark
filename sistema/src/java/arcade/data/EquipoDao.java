...
public class EquipoDao {
    ...
    public static String select_equipo_tabla() {
        try {
            ...
            for (Equipo c : equipo) {
                renglones += ""
                        + "<tr class='equipo_gestores' id='" + c.getId_equipo() + "' style='cursor: pointer;'>"
    ...
    //==========================================================================
    public static String delete_usuario_equipo(int id_usuario, int id_equipo) {
        try {
            StartConn s = new StartConn();
            String resultado = "";

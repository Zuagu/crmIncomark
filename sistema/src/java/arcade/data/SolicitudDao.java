...
public class SolicitudDao {
    ...
    public static String select_solicitud_tabla_taller(String filtro) {
        try {
            StartConn s = new StartConn();
            String sql = "call arcade_select_ingresos_tabla_taller('" + filtro + "');";
            String renglones;
            s.rs = s.st.executeQuery(sql);
            List<Solicitud> solicitud = new ArrayList<Solicitud>();
            while (s.rs.next()) {
    ...
    public static String insert_usuario(String nombre, String alias, String id_sucursal, String sexo, String telefono, String celular, String email, int codigo_reclutador
        ...
        try {
            ...
            String sql = "call arcade_insert_usuario("
                    + "'" + nombre + "',"
                    + "'" + alias + "',"
                    + "'" + (id_sucursal.equals("Monterrey") ? 1 : id_sucursal.equals("Taller") ? 7 : 6 ) + "',"
                    + "'" + 0 + "',"
                    + "'" + 0 + "',"
    ...
    public static String datos_grafica_dashboart() {
        try {
            ...
            String sql = "select \n"
                    ...
                    + "where date(fecha_insert) >= '2019-01-01' and sucursal != 'Taller' \n"
        ...
        try {
            ...
            if (mes == 0) {
                sql = "select \n"
                        ...
                        + "from arcade_ingresos\n"
                        + "where \n"
                        + " date(fecha) between '" + desde + "' and '" + hasta + "' and sucursal != 'Taller' \n"
                ...
                sql = "select \n"
                        ...
                        + "from arcade_ingresos\n"
                        + "where \n"
                        + " month(fecha) = '" + mes + "' and sucursal != 'Taller' \n"
                        + " order by ano,semana,fecha; ";
            }
            s.rs = s.st.executeQuery(sql);
//            System.out.println(sql);
    ...
    public static String select_datos_informe_vacantes(String desde, String hasta) {
        try {
            ...
            String sql = "select \n"
                    ...
                    + "    count(id) as numero\n"
                    + "from arcade_ingresos \n"
                    + "where sucursal != 'Taller' and fecha between '" + desde + "' and '" + hasta + "' \n"
...
//            System.out.println(sql);
            ...
            String sql_2 = "select \n"
                    ...
                    + "where i.sucursal != 'Taller' and date(u.fecha_alta) between '" + desde + "' and '" + hasta + "'  \n"
...
//            System.out.println(sql_2);
            ...
            String sql_3 = "select \n"
                    ...
                    + "    count(id) as numero\n"
                    + "from arcade_ingresos \n"
                    + "where sucursal != 'Taller' and fecha_ingreso between '" + desde + "' and '" + hasta + "'  \n"
                    + "group by especifica_medio\n"
                    + "order by especifica_medio;";
    ...
    public static String select_datos_informe_individual_vacantes(String desde, String hasta, String id_reclutador) {
        try {
            ...
            String sql = "select \n"
                    ...
                    + "    count(id) as numero\n"
                    + "from arcade_ingresos \n"
                    + "where sucursal != 'Taller' and fecha between '" + desde + "' and '" + hasta + "' and reclutador = '" + id_reclutador + "' \n"
                    + "group by especifica_medio\n"
                    + "order by especifica_medio;";
            s.rs = s.st.executeQuery(sql);
            System.out.println(sql);
            ...
            String sql_2 = "select \n"
                    ...
                    + "from  arcade_usuarios u\n"
                    + "left join arcade_ingresos i on i.nombre = u.nombre\n"
                    + "where sucursal != 'Taller' and date(u.fecha_alta) between '" + desde + "' and '" + hasta + "' and i.reclutador = '" + id_reclutador + "' \n"
                    + "group by i.especifica_medio\n"
                    + "order by i.especifica_medio;";
            s.rs = s.st.executeQuery(sql_2);
            System.out.println(sql_2);
            ...
            String sql_3 = "select \n"
                    ...
                    + "    count(id) as numero\n"
                    + "from arcade_ingresos \n"
                    + "where sucursal != 'Taller' and fecha_ingreso between '" + desde + "' and '" + hasta + "' and reclutador = '" + id_reclutador + "' \n"
                    + "group by especifica_medio\n"
                    + "order by especifica_medio;";
            s.rs = s.st.executeQuery(sql_3);
            System.out.println(sql_3);
...
//                System.out.println(solicitud.size());
    ...
    //==========================================================================
    public static String select_reporte_bajas_rango(String desde, String hasta, String opcion) {
        try {
            StartConn s = new StartConn();
            String resultado = "";
            String sql = "call select_reporte_bajas('" + desde + "','" + hasta + "');";
            s.rs = s.st.executeQuery(sql);
            System.out.println(sql);
            List<Solicitud> solicitud = new ArrayList<Solicitud>();
            while (s.rs.next()) {
                ...
                c.setNombre(s.rs.getString("nombre"));
                c.setFecha_alta(s.rs.getString("Fecha_alta_sistema"));
                c.setFecha_baja(s.rs.getString("Fecha_baja_sistema"));
                c.setFecha_primera_sesion(s.rs.getString("Primer_inicio_sesion"));
                c.setFecha_ultima_sesion(s.rs.getString("Ultimo_inicio_sesion"));
                c.setHorario(s.rs.getString("horario"));
                c.setPuesto(s.rs.getString("puesto"));
                solicitud.add(c);
//                System.out.println(solicitud.size());
            }
            if (opcion.equals("valor")) {
                ...
                resultado = ""
                        + "<table id='tabla_reporte_bajas' class='striped bordered highlight'><thead><tr>"
                        + "<th>ID</th>"
                        + "<th>NOMBRE</th>"
                        + "<th>ALTA</th>"
                        + "<th>BAJA</th>"
                ...
                for (Solicitud c : solicitud) {
                    resultado += ""
                            + "<tr id='" + c.getId_usuario()+ "' style='cursor: pointer;'>"
                            + "<td>" + c.getId_usuario()+ "</td>"
                            + "<td>" + c.getNombre() + "</td>"
                            + "<td>" + c.getFecha_alta()+ "</td>"
                            + "<td>" + c.getFecha_baja()+ "</td>"
                            + "<td>" + c.getFecha_primera_sesion()+ "</td>"
                            + "<td>" + c.getFecha_ultima_sesion()+ "</td>"
                            + "<td>" + c.getHorario()+ "</td>"
                            + "<td>" + c.getPuesto()+ "</td>"
                            + "</tr>";
                }

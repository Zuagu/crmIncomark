...
//==============================================================================
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //======================================================================
       else if ("select_solicitudes_tabla_taller".equals(accion)) {
            String renglones = SolicitudDao.select_solicitud_tabla_taller(
                    request.getParameter("filtro")
            );
            response.setContentType("text/html; charset=UTF-8");
            PrintWriter writer = response.getWriter();
        ...
        else if ("select_reporte_bajas_rango".equals(accion)) {
            String renglones = SolicitudDao.select_reporte_bajas_rango(
                    request.getParameter("desde"),
                    request.getParameter("hasta"),
                    request.getParameter("opcion")
            );

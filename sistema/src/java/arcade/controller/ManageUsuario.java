...
public class ManageUsuario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("iniciar_sesion".equals(accion)) {
            ...
            System.out.println( "Cliente: " + request.getParameter("id_usuario") + " ip: " + ip + "  Host:" + host);
            ...
            String renglones = UsuarioDao.update_usuario_rrhh(
                    ...
                    request.getParameter("con_contratacion")
            );
            response.setContentType("text/html; charset=UTF-8");
            PrintWriter writer = response.getWriter();
            writer.print(renglones);
        ...
        else if ("select_datos_carta_baja".equals(accion)) {
            String renglones = UsuarioDao.select_datos_carta_baja(
                    Integer.parseInt(request.getParameter("id"))
            );
            response.setContentType("text/html; charset=UTF-8");
            PrintWriter writer = response.getWriter();
        ...
        else if ("baja_usuario".equals(accion)) {
            String renglones = UsuarioDao.baja_usuario(
                    Integer.parseInt(request.getParameter("id_usuario")),
                    Integer.parseInt(request.getParameter("status")),
                    request.getParameter("fecha_baja"),

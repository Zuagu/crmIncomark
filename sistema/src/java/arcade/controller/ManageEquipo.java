...
//==============================================================================
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //======================================================================
        if ("select_equipo_tabla".equals(accion)) {
            String renglones = EquipoDao.select_equipo_tabla();
        ...
        else if ("select_equipo_check".equals(accion)) {
        ...
        else if ("agregar_gestor_equipo".equals(accion)) {
            String renglones = EquipoDao.agregar_gestor_equipo(
                    Integer.parseInt(request.getParameter("id_equipo")),
        ...
        else if ("delete_usuario_equipo".equals(accion)) {
            String renglones = EquipoDao.delete_usuario_equipo(

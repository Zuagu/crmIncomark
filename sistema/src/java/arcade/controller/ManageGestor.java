...
//==============================================================================
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        else if ("insert_enviar_block".equals(accion)) {
            String renglones = GestorDao.insert_enviar_block(
                    Integer.parseInt(request.getParameter("id_usuario")),
        ...
        else if ("select_texto_block".equals(accion)) {
            String renglones = GestorDao.select_texto_block(
                    Integer.parseInt(request.getParameter("id_usuario"))
            );
            response.setContentType("text/html; charset=UTF-8");
            PrintWriter writer = response.getWriter();

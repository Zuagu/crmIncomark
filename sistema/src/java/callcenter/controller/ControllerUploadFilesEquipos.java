 ...
 * @author zuagu
 */
public class ControllerUploadFilesEquipos extends HttpServlet {
...
//                        filePath = "C:\\\\Users\\\\Public\\\\" + fileName;
            ...
            if(status_file) {
                responseDb = ModelProcesadorCsv.cargar_equipos_azteca(filePath);
            ...
            request.setAttribute("message_db", responseDb);
            request.setAttribute("jsp_redirecion", "cargar_equipos_azteca.jsp");
        }

    ...
    <body>
        ...
        <div class="container-fluid">
                ...
                <div class="col s12 m12 l12" style="margin-left:1.5%">
                    ...
                    <div class="col s12 m6 l4">
                        <div class="col s12 m12 l5 z-depth-3 letcolor" style=" background:linear-gradient(to left,rgba(0,93,170,0.6), rgba(0,93,170,1));border-radius: 3px; padding-right: 18px; padding-left: 18px;margin-bottom:5%"> 
                            ...
                            <h4 id="cita" class="center-align">0</h4>
                        </div>
                        <div class="col s12 m12 l5 offset-l1 z-depth-3 letcolor" style=" background:linear-gradient(to left,rgba(0,93,170,0.6), rgba(0,93,170,1));border-radius: 3px; padding-right: 18px; padding-left: 18px;margin-bottom:5%"> 
                            <h6 class="center-align">Reporte de Bajas</h6>
                            <h4 id="reporte_bajas" class="center-align">0</h4>
                        </div>
            ...
            <div id="modal8" class="modal">
                <div class="modal-content">
                    <h4>Citas</h4>
                    <div id="reporte_bajas_div"></div>
                </div>
                <div class="modal-footer">
                    <a onclick="tableToExcel('reporte_bajas_div', 'CITAS')" class="waves-effect waves-light btn green" style="margin-left: 5px;width: 50px;border-radius: 4px;height:29px;margin-bottom: 5px;"><i class="material-icons" style="margin: -10px;">explicit</i></a>
                </div>
            </div>
            <!------------------------------------------------FIN MODALES------------------------------------------------>
            <!--END PAGE WRAPPER-->
        ...
        <script type="text/javascript">
            ...
            $("#reporte_bajas").on("click", () => {
                $('#modal8').modal('open');
                if ($("#desde").val() == "" && $("#hasta").val() == "") {
                    select_reporte_bajas_rango("reporte_bajas_div", "0000-00-00", "0000-00-00", "tabla");
                } else {
                    select_reporte_bajas_rango("reporte_bajas_div", $("#desde").val(), $("#hasta").val(), "tabla");
                }
            });
            //==================================================================
            $("#enviar").on("click", () => {
                if ($("#desde").val() == '' || $("#hasta").val() == '') {
                    ...
                    select_reporte_bajas_rango("reporte_bajas", $("#desde").val(), $("#hasta").val(), "valor");

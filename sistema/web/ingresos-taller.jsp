    ...
    <body id="body">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s3 offset-s1">
                                <select id="puesto_nuevo" class="">
                                    ...
                                    <option value="Lava Coches">Lava Coches</option>
                                    <option value="Auxiliar Mecanico">Auxiliar Mecanico</option>
                            ...
                            <div class="input-field col s4 ">
                                ...
                                <label  style="width:205px">A trabajado en un Taller Mecanico:</label>
                            </div>
                            <!--                            modifique esta-------------------------------------------------------------------------------------->
                            <div class="input-field col s3 offset-s1 hide">
                                <select id="exp">
                                    <option value="" disabled selected></option>
                ...
                <div id="div_evaluacion" class="col s10 offset-s1 show_print" style="display:none;">
                    <div class="row">
                        ...
                        <div class="input-field col s4 ">
                            ...
                            <label for="dato37">A trabajado en un Taller Mecanico:</label>
                        </div>
                        <div class="input-field col s3 offset-s1 ">
                            <select id="dato4">
                                <option value="" disabled selected></option>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                select_solicitudes_tabla_taller("", "listado_solicitudes");

    ...
    <body>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                select_datos_entradas(7, "0000-00-00");
                $('select').formSelect();
...
//            });
            ...
            $("#icono").click(function () {
                ...
                if ($("#fecha" == "")) {
                    ...
                    select_datos_entradas(7, $("#fecha").val());
                }
                window.setTimeout(() => {
            ...
            /* _________________________________________________________________________ */
            $("#act_horario").click(function () {
                if ($('#usuario_sistema', parent.document).val() == "1433" || $('#usuario_sistema', parent.document).val() == "1432" || $('#usuario_sistema', parent.document).val() == "14") {

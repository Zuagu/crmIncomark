            ...
            <div class="container-fluid">
                <div class="col s12 m12 l12 contenido-datos">
                    ...
                    <div class=" col s12 m5 l5">
                        <div id="info_gestor" class="col s12 m12 l12 z-depth-1 div_input_gestor_info white">
                            <div class="col s12 m12 l12">
                            ...
                            <div class="input-field col s6 m6 l6">
                                <input id="FECHA ACTUALIZACION" type="text" class="validate" placeholder="" readonly="readonly"  value="">
                                <label for="FECHA ACTUALIZACION"><b>F. ASIGNACION</b></label>
                            </div>
                            <div class="input-field col s6 m6 l6">
                                <input id="FECHA ASIGNACION" type="text" class="validate" placeholder="" readonly="readonly"  value="">
                                <label for="FECHA ASIGNACION"><b>F. ASIGNACION</b></label>
                            </div>
                            <div class="input-field col s6 m6 l6">

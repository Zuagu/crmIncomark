...
;
//==============================================================================
function select_caja_ciclos(_id_caja,_cadena_asignaciones) {
    var params = {
        accion: "select_caja_ciclos",
...
;
//==============================================================================
function select_caja_estados(_id_caja,_cadena_asignaciones, _cadena_ciclos) {
    var params = {
        accion: "select_caja_estados",
        cadena_asignaciones: _cadena_asignaciones,
        cadena_ciclos: _cadena_ciclos
    };
    $.ajax({
        type: "POST",
        url: "/sistema/ManagePredictivo",
...
;
//==============================================================================
function select_caja_status(_id_caja, _cadena_asignaciones,_cadena_ciclos, _cadena_estados) {
    var params = {

...
//            console.log(datos_cuenta);
            ...
            $("#datos_marcacion_directa").append(`
                ...
                <li class="collection-item black-text">${datos_cuenta.NOM_TEL_PRINCIPAL}.<a class="right num_phone" href="zoiper://${datos_cuenta.TELEFONO_PRINCIPAL_2}"><i class="material-icons small">local_phone</i>${datos_cuenta.TELEFONO_PRINCIPAL_2}</a> <a class="right num_phone" href="zoiper://${datos_cuenta.TELEFONO_PRINCIPAL}"><i class="material-icons small">phone_iphone</i>${datos_cuenta.TELEFONO_PRINCIPAL}</a></li>

...
//==============================================================================
function insert_enviar_block(_id_usuario, _block) {
    var params = {
        accion: "insert_enviar_block",
        id_usuario: _id_usuario,
        block: _block
    };
     console.log(params);
...
//==============================================================================
function select_texto_block(_id_usuario, _block) {
    var params = {
        accion: "select_texto_block",
        id_usuario: _id_usuario
    };
    $.ajax({
        type: "POST",

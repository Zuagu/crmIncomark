<%-- 
    Document   : predictivo_azteca
    Created on : 12/07/2020, 08:37:10 AM
        ...
        <div class="row" id="contenido">
            <div class="container-fluid">
                <div class="col s9 m9 l9 contenido-datos">
                    ...
                    <input id="ID_CLIENTE" type="hidden"  value="${cuenta}">
                    ...
                    <div class=" col s12 m12 l12  div_gestor_gestion">
                        <div class=" col s12 m12 l12 z-depth-1 div_gestor_textarea grey lighten-5 input_gestion">
                            <textarea id="gestion" class="materialize-textarea limpiar_texto" data-length="700" placeholder="Gestion">${telefono} </textarea>
                        </div>
                    </div>
                    <div class=" col s12 m12 l12  div_gestor_gestion">
                            <div class="input-field col s6 m6 l6">

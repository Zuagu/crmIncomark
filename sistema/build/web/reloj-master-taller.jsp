...
<html lang="en">
    ...
    <body  style="background-image: url('images/racer.jpg');background-size: 100%;background-repeat: no-repeat;background-position: top;">
        <div class="row">
            ...
            <div class=" col s10 offset-s1 content wrap" style="margin-top: 5.33%;;margin-left:8.333%;;background-color: rgba(255,255,255, 0.4);height: 90%;">
                <div class="widget">
                    <div class="fecha">
                    ...
                    <div ><img src="images/sgs.png" class="align-center" style="height: 170px; width: 300px;"></div>
                </div>

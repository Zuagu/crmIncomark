...
function partir_datos(dataRes, _campo, _forlimit) {
    ...
    $("#contratacion").empty();
    $("#contratacion").append(campos[23] + '<option value="0">NO CONTRATABLE</option><option value="1">CONTRATABLE</option>');

    $("#comentario_con").empty();
    $("#comentario_con").append(campos[22]);
    $("#comentario_con").focus();
    ...
    if(campos[24] == "1") {
        $(".div_contratacion").addClass("hide");
    }
}
;
//==============================================================================
...
;
//==============================================================================
function update_usuario_rrhh(_id_seleccion, _d1, _d2, _d3, _d4, _d5, _d6, _d7, _d8, _d9, _d10, _d11, _contratacion, _con_contratacion) {
    var params = {
        ...
        con_contratacion: _con_contratacion
    };
//    console.log(params);
    $.ajax({
        type: "POST",
...
;
//==============================================================================
function select_dato_carta_baja(_id, _nom_mes) {
    var params = {
        accion: "select_datos_carta_baja",
        id: _id
    };
    $.ajax({
        type: "POST",
...
//            console.log(dataRes);
            ...
            $("#fecha_inicio").val("( " + dataRes["fecha_ingreso"] + " )");
            $("#nombre").val(dataRes["nombre"]);
            $("#nombre2").val(dataRes["nombre"]);
        }
    });
}
;
...
;
//==============================================================================
function baja_usuario(_id_usuario, _status,_fecha_baja, _comentario) {
    var params = {
        accion: "baja_usuario",
        id_usuario: _id_usuario,
        status: _status,

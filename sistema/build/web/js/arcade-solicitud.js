...
;
//==============================================================================
function select_solicitudes_tabla_taller(_filtro, _id_caja) {
    var params = {
        accion: "select_solicitudes_tabla_taller",
        filtro: _filtro
    };
    $.ajax({
        type: "POST",
...
;
//==============================================================================
function select_reporte_bajas_rango(_id_caja, _desde, _hasta, _opcion) {
    var params = {
        accion: "select_reporte_bajas_rango",
        desde: _desde,
        hasta: _hasta,
        opcion: _opcion
    };

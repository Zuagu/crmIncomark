...
;
//==============================================================================
function select_usuarios_equipo(_id_equipo, _id_caja) {
    var params = {
        accion: "select_usuarios_equipo",
        id_equipo: _id_equipo
    };
    $.ajax({
        type: "POST",
...
;
//==============================================================================
function delete_usuario_equipo(_id_gestor, _id_equipo) {
    var params = {
        accion: "delete_usuario_equipo",

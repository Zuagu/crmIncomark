            ...
            <div class="modal-content">
                ...
                <div id="div_filtro" class="col s12 m12 l12">
                    <div class="row">
                        ...
                        <!-- asignaciones -->
                        <input id="cadena_ciclos" class="col s12 m2 l2" type="hidden">
                        <div id="div_ciclos" class="col s12 m2 l2"></div>
                        <!-- estados -->
...
//            });
            ...
            $(".check_asignacion").live("click", function () {
                ...
                if ($("#cadena_asignaciones").val() != '') {
                    select_caja_ciclos('div_ciclos', $("#cadena_asignaciones").val());
                } else {
                    $("#div_ciclos").empty(); // limpiar la sig caja de estados
                }
            });
            //===========================
            $("#check_asignacion_todos").live("click", function () {
             ...
             //===========================
                 $(".check_ciclos").live("click", function () {
                var _texto;
                $("#cadena_ciclos").val('');
                $('#div_ciclos .check_ciclos').each(function () {
                    if ($(this).is(':checked')) {
                        $("#cadena_ciclos").val($("#cadena_ciclos").val() + "'" + $(this).attr("id") + "', ");
                    }
                });
                _texto = $("#cadena_ciclos").val();
                _texto = _texto.substring(0, _texto.length - 2);
                $("#cadena_ciclos").val(_texto);
                _texto = $("#cadena_ciclos").val();

                if ($("#cadena_ciclos").val() != '') {
                    select_caja_estados('div_estados', $("#cadena_asignaciones").val(), $("#cadena_ciclos").val());

                } else {
                    $("#div_estados").empty(); // limpiar la sig caja de texto
                }
            });
            //===========================
            $("#check_ciclos_todos").live("click", function () {
                if ($("#check_ciclos_todos").is(":checked")) {
                    $(".check_ciclos").prop("checked", true);
                } else {
                    $(".check_ciclos").prop("checked", false);
                }
                var _texto;
                $("#cadena_ciclos").val('');
                $('#div_ciclos .check_ciclos').each(function () {
            ...
            $(".check_estado").live("click", function () {
                ...
                if ($("#cadena_estados").val() != '') {
                    select_caja_status('div_status', $("#cadena_asignaciones").val(),$("#cadena_ciclos").val(), $("#cadena_estados").val());

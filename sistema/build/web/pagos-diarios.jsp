                ...
                <div class="row">
                    <div class="col s10 offset-s1 hide_print">
                        ...
                        <div class="input-field col s5" >
                            <input id="desde" name="fecha" type="text" class="validate datepicker" readonly="" style="text-align: center;border: solid 1px gray !important;border-radius: 4px !important;font-weight: bold; width:100px; padding:-5px;margin-bottom: -5px;height: 27px;margin-left: 10px;"></td>

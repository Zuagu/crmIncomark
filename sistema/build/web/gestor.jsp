    ...
    <body style="background-image: url('images/background-cliente.png');">
        ...
        <div class="contenedor-responsive">
            ...
            <div id="barra_menus" class="datagrid" style="width: 99%;border:none;padding: 0px;background: transparent;">
                ...
                <div id="bm9" class="div_boton_menu" title="BLOCK DE NOTAS." style="background-image: url('images/botones-operacion/btn10.png');"></div>
            ...
            <div class="datagrid" class="esconder_tool" style="width: 72%;margin-left: .4%;float: left;height:210px;overflow:auto;">
                ...
                <div id="divapp9" class="esconder_tool" style="display:none;height:208px;overflow: auto;">
                    <div style="padding: 20px 40px;color: #9CB8C3;text-align: center;">
                        ...
                        <textarea id="block_notas" style="color:black">
                         
                        </textarea>
                        <br>
                        <input id="insert_block" type="button" value="GUARDAR">
                    </div>
                </div>
                <div id="divapp9" class="esconder_tool" style="display:none;height:208px;overflow: auto;">
                        ...
                        <tbody>
                            <tr>
                                <td  style="font-size: 1.5rem">
                                    <div id="speech_cuenta" class="datagrid sombra" style="width: 100%;height: 160px;color: #000;margin: 6px 0 11px 0;overflow: auto;">
                                        <p style="text-align:justify"> MENSAJE URGUENTE PARA _____ LE ESTAMOS MARCANDO DEL DESPACHO JURIDICO SICSA REFERENTE AL INCXUMPLIMIENTO DE CONTRATO EN LA LINEA DE CELULAR
                                            CON TERMINACION ____________ EL CUAL PRESENTA UN SALDO VENCIDO, URGE SE PRESENTE A REALIZAR EL PAGO CORRESPONDIENTE O BIEN SE REPORTE PARA LLEGAR A UN 
                                            ACUERDO AL TELEFONO 01 81  19323844
                                        </p>
                                        <br>
                                        <p style="text-align:justify"><strong>
                                                "GRABA EL BUZON NO LO IGNORES MUCHOS PAGOS LO REALIZAN AL DEJAR UN BUEN BUZON CLARO"
                                            </strong>
        ...
        <script type="text/javascript">
            ...
            $("#btnsiguiente").click(
                    function () {
                        if ($("#id_estatus_cuenta").val() != 100) {
                            select_cuenta_siguiente($('#usuario_sistema', parent.document).val());
                        } else
                            alert("Escoge un codigo para Gestionar");
                    }
            );
            //==================================================================
            ...
            $("#id_estatus_llamada").change(function () {
              ...
              //==================================================================
            $("#insert_block").click(function () {
                insert_enviar_block($('#usuario_sistema', parent.document).val(),$('#block_notas').val());
            ...
            //==================================================================
            $("#bm9").click(function () {
                select_texto_block($('#usuario_sistema', parent.document).val(),'block_notas');
